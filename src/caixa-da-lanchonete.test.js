...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ...
        ['queijo com outro item', 'debito', 'Item extra não pode ser pedido sem o principal', ['chantily,1', 'queijo,1']],
        ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
            validaTeste(formaDePagamento, resultadoEsperado, itens));

    test.each([
        ['queijo', 'dinheiro', 'Item extra não pode ser pedido sem o principal', ['queijo,1']],
        ['chantily com outro item', 'credito','Item extra não pode ser pedido sem o principal', ['chantily,2', 'combo1,1']],
        ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
    ...
    test.each([
        ['dinheiro', 'R$ 32.30', ['combo1,2', 'combo2,2']],
        ['credito',  'R$ 35.02', ['combo1,2', 'combo2,2']],
        ['debito',   'R$ 34.00', ['combo1,2', 'combo2,2']],
    ])('compra de múltiplas quantidades em %p deve resultar em %p', validaTeste);  

    test.each([
        ['dinheiro', 'R$ 13.01', ['suco,1', 'combo2,1']],
        ['credito', 'R$ 14.11', ['suco,1', 'combo2,1']],
        ['debito', 'R$ 13.70', ['suco,1', 'combo2,1']],
    ])('compra de 3 items em %p deve resultar em %p', validaTeste);

    test.each([
        ['dinheiro', 'R$ 6.89', ['salgado,1']],
        ['credito', 'R$ 7.47', ['salgado,1']],
